  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Meet Michael — a fully qualified painter and decorator with 30 years' experience in Christchurch. Spray finishing, wall coverings and specialist coatings." />
