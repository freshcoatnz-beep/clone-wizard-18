...
const Interior = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[450px] lg:min-h-[600px] bg-cover bg-center bg-no-repeat hero-curved" style={{ backgroundImage: `url(/lovable-uploads/560cfc8a-03cc-4357-9065-7edfbe508f66.png)`, backgroundPosition: 'center 70%' }}>
        {/* Overlay */}
