...
const Interior = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[500px] lg:min-h-[650px] bg-cover bg-center bg-no-repeat hero-curved" style={{ backgroundImage: `url(/lovable-uploads/560cfc8a-03cc-4357-9065-7edfbe508f66.png)`, backgroundPosition: 'center 70%' }}>
        {/* Overlay */}
        <div className="absolute inset-0 bg-gradient-hero hero-curved"></div>
        
        {/* Content */}
        <div className="relative container mx-auto px-4 py-12 lg:py-32 flex items-end min-h-[450px] lg:min-h-[600px]">
