          ...
          <div className="max-w-5xl mx-auto text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-stretch sm:items-center mt-8">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-md border-2 border-green-600 bg-green-600 px-6 py-3 text-base font-semibold text-white transition-colors hover:bg-green-700 hover:border-green-700"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <a href="/projects/roof-restoration-merivale-tile-roof" className="text-brand-blue font-semibold hover:underline">View this project →</a>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
