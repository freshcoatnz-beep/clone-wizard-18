...
export const Hero = () => {
  return (
    <section className="relative min-h-[450px] lg:min-h-[600px] bg-cover bg-center bg-no-repeat hero-curved" style={{ backgroundImage: `url(${heroImage})`, backgroundPosition: 'center 20%' }}>
      {/* Overlay */}
      ...
      <div className="relative container mx-auto px-4 py-12 lg:py-18">
        <div className="max-w-5xl mx-auto text-center text-white">
          ...
          <Button variant="hero" size="lg" className="text-xl px-12 py-6 font-semibold bg-blue-600 hover:bg-blue-700 text-white border-blue-600 mt-24">
            Get FREE Quote
          </Button>
        </div>
      </div>
