        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg mb-6 text-muted-foreground leading-relaxed">
              ...
              <strong className="text-brand-gray"> Freshcoat Painting</strong> is a leading painting company with over 20 years of experience transforming homes, strata, and small commercial properties throughout Sydney.
            </p>
