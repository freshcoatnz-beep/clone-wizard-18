        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-3xl lg:text-4xl font-bold mb-6 text-brand-gray">
              Welcome to Advanced Painting Pty Ltd
            </h2>
            <p className="text-lg mb-6 text-muted-foreground leading-relaxed">
              Looking for reliable painters in Sydney who deliver professional, high-quality finishes? 
              <strong className="text-brand-gray"> Advanced Painting</strong> is a leading painting company with over 20 years of experience transforming homes, strata, and small commercial properties throughout Sydney.
            </p>
