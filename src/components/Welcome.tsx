        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg mb-6 text-muted-foreground leading-relaxed">
              Looking for experienced <a href="/painter-and-decorator-christchurch" className="text-brand-blue hover:underline font-semibold">painters and decorators in Christchurch</a> who deliver flawless results?
