  ...
  return (
    <header className="bg-background shadow-soft">
      ...
      <div className="border-b border-border bg-gray-50">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center text-lg font-medium">
          <div className="flex items-center gap-2 text-brand-gray">
            <Phone size={20} />
            <span className="text-lg font-semibold">022 0366586</span>
          </div>
          <div className="flex items-center gap-2">
            ...
            <a 
              ...
              className="flex items-center justify-center bg-white rounded-full w-10 h-10 shadow-sm hover:shadow-md transition-shadow cursor-pointer"
            >
