      ...
      <div className="border-b border-border bg-gray-50">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center text-xl font-medium">
          ...
          <a 
            ...
            aria-label="Freshcoat Painting — 5.0 star rating on Google Reviews (7 reviews)"
            className="flex items-center gap-3 mr-4 hover:opacity-90 transition-opacity cursor-pointer"
          >
            {/* Google G Icon */}
            <div className="flex items-center justify-center bg-white rounded-full w-12 h-12 shadow-sm hover:shadow-md transition-shadow" aria-hidden="true">
            ...
            <span aria-hidden="true" className="text-yellow-500 text-2xl leading-none">★</span>
      ...
      <div className="container mx-auto px-4 py-6 bg-white shadow-sm">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            {false && <a href="/projects" className="transition-colors font-semibold text-lg text-black">Projects</a>}
